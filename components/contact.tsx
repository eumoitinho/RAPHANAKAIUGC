          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                ...
                <Link href='https://www.tiktok.com/@raphanakai?lang=pt-BR' target='__blank' className="w-10 h-10 rounded-full bg-[#252525] flex items-center justify-center hover:bg-[#d87093] transition-colors">
