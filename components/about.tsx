        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-2 md:order-1">
            <div className="relative aspect-[3/4] max-w-md mx-auto md:ml-0">
              <div className="absolute -top-4 -left-4 w-24 h-24 rounded-full bg-[#d87093]/10 -z-10"></div>
              ...
              {/* Experience badge */}
              <div className="absolute -bottom-5 -right-5 bg-[#1e1e1e] shadow-lg rounded-lg p-4 flex items-center">
