    ...
    return (
      <div className="p-4 bg-[#252525] rounded-lg">
        ...
        <div className="text-xs text-gray-400 mb-3">
          <p>Storage bucket environment variable: {process.env.FIREBASE_STORAGE_BUCKET || "Not set"}</p>
        ...
        {status === "error" && (
          <div className="mt-2 text-xs text-red-400">
            ...
            <p className="mt-1">
              Make sure the FIREBASE_STORAGE_BUCKET environment variable is set correctly. It should be in the
